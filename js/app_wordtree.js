...
function resize() {
  ...
  var Stem = function() {
	var enStemmer = new Snowball("english");
...
var positive_terms = ['dream', 'final', 'brain', 'saw', 'mind', 'oscar', 'ver',
...
var negative_terms = ['dog', 'funni', 'cat', 'suck', 'twilight', 'watchin',
...
var actor_terms = ['trey', 'treysongz', 'treysongza', 'songz', 'aadaddario',
				  'alexandra', 'daddario', 'scott', 'eastwood', 'scotteastwood'];
...
//	if (positive_terms.indexOf(Stem() (token.lower)) >= 0) console.log(token.token);
    tokens.push(token);
    line.push(token);
    i = re.lastIndex;
  }
